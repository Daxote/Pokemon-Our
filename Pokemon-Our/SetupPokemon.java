public class SetupPokemon{
	...
	public static final String [][] ataques = {{"Impactrueno","Látigo","Gruñido"},{"Látigo","Placaje","Burbuja"},{"Placaje","Gruñido","Drenadoras"},{"Placaje"," Ascuas"," Pisoton"},{"Ataque Rapido"," Picotazo"," Ala Acero"},{"Arañazo"," Ascuas"," Gruñido"},{"Llamarada"," Furia Dragon"," Pantalla Humo"},{"Placaje"," Latigo"," Mordisco"},{"Lanzallamas"," Ataque Rapido"," Mordisco"}};
	public static final String [] abilidades = {"Impactrueno","latigo","Gruñido"};
